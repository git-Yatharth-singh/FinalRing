...
public class MatchController {
    ...
    public ResponseEntity<MatchResponse> createMatch(@Valid @RequestBody MatchRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(matchService.createMatch(request, email));
    }
    ...
    public ResponseEntity<MatchResponse> startMatch(
            @PathVariable long matchId) throws NotCreatorException {
    ...
    public ResponseEntity<List<MatchResultResponse>> resultMatch(
